...
**Nota de entrega (2026-09-16):** este hallazgo se corrigió el mismo día 2026-09-15, pero el commit no llegó a incluirse en la rama que se subió a GitHub y se integró a `main` -- se aplicó por separado al día siguiente, directamente sobre `main`, en cuanto se detectó la omisión al verificar el código ya publicado.
